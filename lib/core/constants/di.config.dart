...
import '../../features/auth/sign_up/presentation/bloc/sign_up_bloc.dart'
    as _i130;
import '../../features/cart/data/datasource/cart_data_source.dart' as _i873;
import '../../features/cart/data/repo/cart_repo_impl.dart' as _i234;
import '../../features/cart/domain/repo/cart_repo.dart' as _i379;
import '../../features/cart/domain/usecase/cart_usecase.dart' as _i632;
...
import '../../features/navigation_layout/tabs/categories/presentation/bloc/spacific_product/spacific_product_bloc.dart'
    as _i805;
import '../../features/navigation_layout/tabs/favorite/data/data_source/favorite_ds.dart'
    as _i196;
import '../../features/navigation_layout/tabs/favorite/data/repo/favorite_repo.dart'
    as _i711;
import '../../features/navigation_layout/tabs/favorite/domain/repo/favorite_repo.dart'
    as _i720;
import '../../features/navigation_layout/tabs/favorite/domain/usecase/favorite_usecase.dart'
    as _i697;
import '../../features/navigation_layout/tabs/favorite/presentation/bloc/favorite_bloc.dart'
    as _i250;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i196.FavoriteDs>(() => _i196.FavoriteDsImpl());
    ...
    gh.factory<_i720.FavoriteRepo>(
        () => _i711.FavoriteRepoImpl(gh<_i196.FavoriteDs>()));
    ...
    gh.factory<_i873.CartDataSource>(() => _i873.CartDSImpl());
    ...
    gh.factory<_i697.FavoriteUsecase>(
        () => _i697.FavoriteUsecase(gh<_i720.FavoriteRepo>()));
    ...
    gh.factory<_i379.CartRepo>(
        () => _i234.CartRepoImpl(gh<_i873.CartDataSource>()));
    ...
    gh.factory<_i250.FavoriteBloc>(
        () => _i250.FavoriteBloc(gh<_i697.FavoriteUsecase>()));
    ...
    gh.factory<_i632.CartUsecase>(
        () => _i632.CartUsecase(gh<_i379.CartRepo>()));
    gh.factory<_i1073.GetCartItemsUsecase>(
        () => _i1073.GetCartItemsUsecase(gh<_i379.CartRepo>()));
    ...
    gh.factory<_i118.GetAllProductsBloc>(() => _i118.GetAllProductsBloc(
          gh<_i120.GetAllProductsUsecase>(),
          gh<_i632.CartUsecase>(),
        ));
    ...
    gh.factory<_i906.CartBloc>(() => _i906.CartBloc(
          gh<_i632.CartUsecase>(),
          gh<_i1073.GetCartItemsUsecase>(),
        ));
